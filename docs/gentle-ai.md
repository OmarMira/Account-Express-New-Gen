...
| `sistema/AGENTS.md` | Overrides específicos del proyecto |
...
| sdd-propose | opus | Decisiones arquitecturales |
| sdd-design | opus | Arquitectura |
| sdd-spec | sonnet | Escritura estructurada |
| sdd-apply | sonnet | Implementación |
| sdd-verify | sonnet | Validación contra specs |
| sdd-archive | haiku | Copy y cierre (liviano) |
...
- [`opencode.json`](https://github.com/OmarMira/Account-Express-New-Gen/blob/main/.opencode/opencode.json) — Configuración de agentes
- [`AGENTS.md`](https://github.com/OmarMira/Account-Express-New-Gen/blob/main/AGENTS.md) — Instrucciones del sistema
