...
`entity-classifier.ts` MUST have unit tests covering `getEntityCandidates` and the core classification logic. Tests MUST use Vitest with no external HTTP dependencies. Target coverage MUST be at least 70% for the classifier module.
