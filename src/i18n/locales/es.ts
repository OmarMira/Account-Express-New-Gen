const es = {
  ...
  learning: {
    ...
    onboardingDesc:
      'Estas entidades fueron detectadas en tus transacciones pero aun no tienen una clasificacion. Asignales un rol y una cuenta contable para mejorar el matching automatico.',
