const es = {
  ...
  journal: {
    title: 'Libro Mayor',
    subtitle: 'Crea y administra asientos del libro mayor de partida doble.',
    newEntry: 'Nuevo Asiento',
    newEntryDesc: 'Crea un nuevo asiento con líneas de cargo y abono.',
    editEntry: 'Editar Asiento',
    editEntryDesc: 'Modifica este asiento en borrador.',
    deleteEntry: 'Eliminar Asiento',
    viewEntry: 'Ver Detalles',
    postEntry: 'Registrar Asiento',
    voidEntry: 'Cancelar Asiento',
    entryDate: 'Fecha',
