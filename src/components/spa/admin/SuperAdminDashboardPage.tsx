          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 border-l pl-4">
              ...
              <div className="hidden sm:block text-left">
                <p className="text-xs font-semibold text-foreground leading-none">{user ? `${user.firstName} ${user.lastName}` : 'Administrador'}</p>
                <p className="text-[10px] text-muted-foreground mt-0.5 leading-none">Super Administrador</p>
              </div>
            </div>
          </div>
        </header>
            ...
            {currentView === 'admin-dashboard' && (
              <div className="space-y-8 animate-in fade-in duration-200">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                  ...
                  >
                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                      <CardTitle className="text-sm font-semibold text-muted-foreground">Usuarios Globales</CardTitle>
                  ...
                  >
                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                      <CardTitle className="text-sm font-semibold text-muted-foreground">Bitácora de Logs</CardTitle>
                  ...
                  <Card className="group">
                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                      <CardTitle className="text-sm font-semibold text-muted-foreground">Carga del Servidor</CardTitle>
                ...
                <div className="grid gap-6 md:grid-cols-3">
                  <Card className="relative overflow-hidden group hover:border-indigo-500/30 transition-colors">
                    <CardHeader>
                      ...
                      <CardDescription>Crea, edita, desactiva o elimina empresas de forma permanente.</CardDescription>
                    </CardHeader>
                  ...
                  <Card className="relative overflow-hidden group hover:border-violet-500/30 transition-colors">
                    <CardHeader>
                      ...
                      <CardDescription>Administra los accesos y roles de super admin y operadores de empresas.</CardDescription>
                    </CardHeader>
                    <CardContent className="pt-2">
                      <Button 
                        variant="secondary" 
                  ...
                  <Card className="relative overflow-hidden group hover:border-emerald-500/30 transition-colors">
                    <CardHeader>
                      ...
                      <CardDescription>Revisa el historial de acciones y operaciones detalladas del sistema.</CardDescription>
                    </CardHeader>
                    <CardContent className="pt-2">
                      <Button 
                        variant="secondary" 
